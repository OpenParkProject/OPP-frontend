...
class _RegistrationPageState extends State<RegistrationPage> {
  ...
  Future<void> _registerUser() async {
    ...
    UserRequest user = UserRequest((b) => b
      ..name = "Simone"
      ..surname = "Tollardo"
      ..email = "simonetollardo@gmail.com"
      ..password = "password"
      ..role = UserRequestRoleEnum.driver
      ..username = "SimoneTollardo"
    );

    UserApi.addUser(userRequest: user).then((value) => print(value.statusCode));
