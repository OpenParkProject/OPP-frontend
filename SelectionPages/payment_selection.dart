...
import 'package:plate_ocr/SelectionPages/parkingTicket.dart';
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            SizedBox(height: 20),
            ElevatedButton(onPressed: navigateToPayment, child: Text('Pay')),
          ],
        ),
      ),
    );
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => ParkingTicketPage(),
                  ),
                );
              },
              child: Text("Check your ticket"),
            ),
          ],
        ),
      ),
